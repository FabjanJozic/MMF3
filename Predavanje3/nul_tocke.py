...
def met_NR(function, deriv_function, x, epsilon, A, B, C, D, E, F):
    ...
    k = 1
    while abs(function(x, A, B ,C, D, E, F)/deriv_function(x, A, B ,C, D, E, F)) < epsilon and k <200:
...
def met_sekanta(function, x, epsilon, A, B ,C, D, E, F):
    ...
    k = 1
    while abs(function(x, A, B, C, D, E, F)/deriv_function(function, x, epsilon, A, B, C, D, E, F)) < epsilon:
