...
with open('C:\\Users\\fabja\\Desktop\\programi\\MMF3\\Predavanje6_Nevilleova_interpolacija\\V(H-H).txt','r') as read1:
...
with open('C:\\Users\\fabja\\Desktop\\programi\\MMF3\\Predavanje6_Nevilleova_interpolacija\\V(H-H)_AK.txt','w') as write1:
    write1.writelines(mod_linija1)

with open('C:\\Users\\fabja\\Desktop\\programi\\MMF3\\Predavanje6_Nevilleova_interpolacija\\V(H-H)_AK.txt','r') as read2:
...
with open('C:\\Users\\fabja\\Desktop\\programi\\MMF3\\Predavanje6\\V(H-H)_inter.txt','w') as write2:
